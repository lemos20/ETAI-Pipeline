"""
Data cleaning function for the pipeline.

This module is responsible for cleaning the data, including category cleanup, domain-rule/placeholder -> NaN conversion, de-duplication, and redundant-column removal.
"""
import numpy as np
import pandas as pd
